...
# <span class="ez-toc-section" id="%E4%BB%80%E9%BA%BC%E6%98%AF_KRaft_%E6%A8%A1%E5%BC%8F%EF%BC%9F"></span>什麼是 KRaft 模式？<span class="ez-toc-section-end"></span> {.wp-block-heading}</p> 
...
<table class="has-fixed-layout">
  ...
  <tr>
    <td>
      KAFKA_CONTROLLER_LISTENER_NAMES=CONTROLLERController
    </td>
  ...
  <tr>
    <td>
      KAFKA_CONTROLLER_QUORUM_VOTERS=1@broker:9093Controller
    </td>
  ...
  <tr>
    <td>
      KAFKA_INTER_BROKER_LISTENER_NAME=PLAINTEXTBroker
    </td>
...
### <span class="ez-toc-section" id="kafka-ui"></span>kafka-ui<span class="ez-toc-section-end"></span> {.wp-block-heading}</p> 
...
<table class="has-fixed-layout">
  ...
  <tr>
    ...
    <td>
      必須與 KAFKA_ADVERTISED_LISTENERS 一致
    </td>
  </tr>
</table></figure> </p> 

### <span class="ez-toc-section" id="%E6%B8%AC%E8%A9%A6%E6%98%AF%E5%90%A6%E6%AD%A3%E5%B8%B8"></span>測試是否正常<span class="ez-toc-section-end"></span> {.wp-block-heading}</p> 
...
## <span class="ez-toc-section" id="docker-composeyml_%E6%8E%A8%E8%96%A6%E6%96%B9%E5%BC%8F"></span>docker-compose.yml (推薦方式)<span class="ez-toc-section-end"></span> {.wp-block-heading}</p> 
