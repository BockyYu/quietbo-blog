---
title: '[Python] LinePay串接Online APIs – 串接v3(含code) (4/5)'
author: Bocky
type: post
date: 2022-03-14T05:38:31+00:00
url: /2022/03/14/python-linepay串接online-apis-串接v3含code-4-5/
categories:
  - Python
tags:
  - linepay
...
if __name__ == "__main__":
    ...
    # if status == True:
        # print(do_confirm(transaction_id))  # 確認訂單</code></pre>