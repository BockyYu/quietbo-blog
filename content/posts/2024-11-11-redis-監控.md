...
參考文章:\[Redis維之監控指標，效能監控，監控方式，反應慢分析\]\[1\]
...
\--- server:伺服器運行的環境參數 clients:客戶端相關訊息 memory：伺服器運行記憶體統計數據 persistence：持久化訊息 stats：通用統計數據 Replication：主從複製相關訊息 CPU：CPU使用情況 cluster：集群資訊 Keypass：鍵值對統計數量信息
